...
namespace ACRCloudRecognitionTest
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                System.Console.Write("Proccesing song...");
                location = System.AppDomain.CurrentDomain.BaseDirectory;
                //location = location.Replace("Mic\\bin\\Debug\\", null);
                //location = location.Replace('\\', '/');
                //location = location + "acrcloud_sdk_csharp-master/ACRCloudRecognitionTest/ACRCloudRecognitionTest/bin/Release";
                ...
                //{
                result = re.RecognizeByFile("test.wav", 0);
                print(result);
                //}
                /**
    *   
    ...
    **/
                using (FileStream fs = new FileStream(@"test.wav", FileMode.Open))
                {
                ...
                using (StreamWriter sw = File.CreateText(location + "\\title.txt"))
                {
                    sw.Write(outPut);
                }
            }
        ...
        static public string location, outPut = "n/a";
        static public void print(string result)
        {
            if (!isDone)
            {
                try
                {
                    ...
                    {
                        //Console.Write("lsknmvkjlsrnrvjknwjknvjhwrb");
                        ...
                        if (words[i] == "title")
                        {
                            ...
                            //File.CreateText(location + "\\title.txt");
                            //File.WriteAllText(location + "\\title.txt", words[i+2]);
                            break;
